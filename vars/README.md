...
Now we have successfully made all the 40 repos to use 3-4 common Shared library. However we now have identified that even the 3-4 shared library scripts have some redudant code. There are few stages that are common among them. 
