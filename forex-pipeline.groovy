...
"""
        ...
        stages {
            ...
            stage('Helm package and push') {
              ...
              curl -u ${ARTIFACTORY_USER}:${ARTIFACTORY_PASSWORD} -T ${JENKINS_PIPELINE_NAME}-${JENKINS_PIPELINE_LABEL}.tgz "https://artifactory.dev.maximus.axisb.com/artifactory/helm/${HELM_DIRECTORY}/${JENKINS_PIPELINE_NAME}/${JENKINS_PIPELINE_NAME}-${GO_PIPELINE_LABEL}.tgz" 
            }
        }
