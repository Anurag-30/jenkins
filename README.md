...
Go for declarative approach as it is better approach , says this guy here - [a link](https://stackoverflow.com/questions/44657896/jenkins-pipeline-jenkinsfile-node-and-pipeline-directives).You can find an example for both of them under 
